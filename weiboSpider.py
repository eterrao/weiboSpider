    ...
    def get_weibo_info(self):
        try:
            ...
            for page in range(1, page_num + 1):
                ...
                # print(etree.tostring(selector2).decode("UTF-8"))

                user_info = selector2.xpath("//div[@class'u']")
                images = user_info.xpath("table/tr/td/div/span[@class='ut")
                print(images[0])
...
def main():
    try:
        ...
        user_id = 3877667526  # 可以改成任意合法的用户id（爬虫的微博id除外）
